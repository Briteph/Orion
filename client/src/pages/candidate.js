...
function CandidateTab() {
    return (
        <>
            <ContentNav>
                <div className='Table'>
                    <Table entryData={Candidates} tableColumns={CandidateCOLUMNS} newEntryLabel="Add Candidate" buttonUrl={"/app/candidate/add-candidate"} rowUrl={"/app/candidate/profile"}/>
                </div>
            </ContentNav>
        </>
    );
