            ...
            <div className="Info_Header flex">
              ...
              <div className=" ml-5 h-1/2">
                ...
                <div className="text-[1.1rem] mb-2">
                  St.Bldg. A, Iligan City
                </div>
                <DropDown
                  buttonClass={"bg-[#5179DF] text-[#ffff]"}
                  label="Open"
                >
                  <div>Open</div>
                  <div>Closed</div>
            ...
            <div className="Other_Details flex mt-7">
              <Card addClass={"mr-4 w-2/3 h-[26rem]"}>
                <div className="tabs flex">
                  <div
                    className={`tab px-8 select-none cursor-pointer ${
                      TabState === "Details"
                        ? " border-b-[3px] border-[#5179DF] "
                        : " "
                    }`}
                    onClick={() => setTabState("Details")}
                  >
                    Details
                  </div>
                  <div
